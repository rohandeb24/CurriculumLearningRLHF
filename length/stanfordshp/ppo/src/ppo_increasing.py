...
# ──────────────────────────────────────────────────────────────────────────────
# Distributed evaluation: SteamSHP reward (match code #1)
# ──────────────────────────────────────────────────────────────────────────────
@torch.no_grad()
...
def main():
    ...
    ppo_epochs = cfg["training"]["num_epochs"]  # for logging / ckpt naming
    ...
    # ------------------------- data
    raw_ds = build_dataset(dataset_name, model_name, dataset_dir, accelerator=accelerator)
    ...
    # ------------------------- LENGTH CURRICULUM (keep from code #2)
    ...
    # ------------------------- reward model (SteamSHP flan-t5-large) (match code #1)
