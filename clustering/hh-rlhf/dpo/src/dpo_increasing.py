...
def main():
    ...
    # cache curriculum ordering alongside dataset cache if available; otherwise under output_dir later
    # (but output_dir not created yet, so use log_dir as a safe always-existing base)
